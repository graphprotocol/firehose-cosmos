...
// Temporary until I get push access to `github.com/graphprotocol/proto-cosmos`
replace github.com/graphprotocol/proto-cosmos => github.com/maoueh/proto-cosmos v0.0.0-20231110170756-b5906304132a
